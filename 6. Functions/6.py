...
pizza_one_diameter = float(input("Enter the diameter of your pizza (in cm): "))
pizza_one_price = float(input("Enter the price of your pizza (in euros): "))
pizza_one_unit_price = pizza_unit_price_calc(pizza_one_diameter, pizza_one_price)

pizza_two_diameter = float(input("Enter the diameter of your pizza (in cm): "))
pizza_two_price = float(input("Enter the price of your pizza (in euros): "))
